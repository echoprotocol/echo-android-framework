...
enum class ObjectType(private val space: Int, private val type: Int) {
    ...
    BLOCK_RESULT_OBJECT(ObjectType.PROTOCOL_SPACE, 13),
    ETH_ADDRESS_OBJECT(ObjectType.PROTOCOL_SPACE, 14),
    DEPOSIT_ETH_OBJECT(ObjectType.PROTOCOL_SPACE, 15),
    WITHDRAW_ETH_OBJECT(ObjectType.PROTOCOL_SPACE, 16),
    ERC20_TOKEN_OBJECT(ObjectType.PROTOCOL_SPACE, 17),
    DEPOSIT_ERC20_TOKEN_OBJECT(ObjectType.PROTOCOL_SPACE, 18),
    WITHDRAW_ERC20_TOKEN_OBJECT(ObjectType.PROTOCOL_SPACE, 19),
    BTC_ADDRESS_OBJECT(ObjectType.PROTOCOL_SPACE, 20),
    BTC_INTERMEDIATE_DEPOSIT_OBJECT(ObjectType.PROTOCOL_SPACE, 21),
    BTC_DEPOSIT_OBJECT(ObjectType.PROTOCOL_SPACE, 22),
    BTC_WITHDRAW_OBJECT(ObjectType.PROTOCOL_SPACE, 23),
    BTC_AGGREGATING_OBJECT(ObjectType.PROTOCOL_SPACE, 24),
