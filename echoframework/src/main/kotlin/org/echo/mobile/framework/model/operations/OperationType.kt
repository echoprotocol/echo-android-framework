...
class OperationTypeToClassConverter : Converter<Int, Class<*>?> {
    ...
    companion object {
        private val operationTypeRegistry = hashMapOf(
                ...
                OperationType.BALANCE_CLAIM_OPERATION.ordinal to IssueAssetOperation::class.java,
                OperationType.BALANCE_FREEZE_OPERATION.ordinal to IssueAssetOperation::class.java,
                OperationType.BALANCE_UNFREEZE_OPERATION.ordinal to IssueAssetOperation::class.java,
                OperationType.REQUEST_BALANCE_UNFREEZE_OPERATION.ordinal to IssueAssetOperation::class.java,
                OperationType.TRANSFER_OPERATION.ordinal to TransferOperation::class.java,
