...
class OperationTypeToClassConverter : Converter<Int, Class<*>?> {
    ...
    companion object {
        private val operationTypeRegistry = hashMapOf(
            ...
            OperationType.SIDECHAIN_ETH_ISSUE_OPERATION.ordinal to SidechainIssueSocketOperation::class.java,
            OperationType.SIDECHAIN_ETH_BURN_OPERATION.ordinal to SidechainBurnSocketOperation::class.java
        )
    }
