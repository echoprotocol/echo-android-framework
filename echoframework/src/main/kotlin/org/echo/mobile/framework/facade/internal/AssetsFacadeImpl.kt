...
class AssetsFacadeImpl(
    ...
    private fun retrieveTransactionResult(callId: String, callback: Callback<TransactionResult>) {
        try {
    ...
    override fun issueAsset(
        ...
        try {
            ...
            callId = networkBroadcastApiService
                    .broadcastTransactionWithCallback(transaction).dematerialize().toString()
            broadcastCallback.onSuccess(true)
