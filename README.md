[ ![Download](https://api.bintray.com/packages/echo/mobile/android-framework-stable/images/download.svg?version=2.0.3) ](https://bintray.com/echo/mobile/android-framework-stable/2.0.3/link)
...
```
implementation 'org.echo.mobile:echoframework:2.0.3'
```
