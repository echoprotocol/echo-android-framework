[ ![Download](https://api.bintray.com/packages/echo/mobile/android-framework-stable/images/download.svg?version=3.0.3) ](https://bintray.com/echo/mobile/android-framework-stable/3.0.3/link)
...
```
implementation 'org.echo.mobile:echoframework:3.0.3'
```
