[ ![Download](https://api.bintray.com/packages/echo/mobile/android-framework-stable/images/download.svg?version=4.2.0) ](https://bintray.com/echo/mobile/android-framework-stable/4.2.0/link)
...
```
implementation 'org.echo.mobile:echoframework:4.2.0'
```
