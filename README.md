[ ![Download](https://api.bintray.com/packages/echo/mobile/android-framework-stable/images/download.svg?version=1.0.6) ](https://bintray.com/echo/mobile/android-framework-stable/1.0.6/link)
...
```
implementation 'org.echo.mobile:echoframework:1.0.6'
```
