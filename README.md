[ ![Download](https://api.bintray.com/packages/echo/mobile/android-framework-stable/images/download.svg?version=4.2.2) ](https://bintray.com/echo/mobile/android-framework-stable/4.2.2/link)
